...
{
private:
string SSN, name, Dept, Designation; float salary;
node *next; node *prev;
...
{
SSN = ssn; name = n; Dept = d;
Designation = des; salary = s;
prev = next = NULL;
}
};
...
{
string ssn, name, dept, designation; float salary;
cout << "Enter the employee details: " << endl; cout << "Name : ";
cin >> name;
cout << "SSN : "; cin >> ssn;
cout << "Department : "; cin >> dept;
cout << "Designation : "; cin >> designation;
cout << "Salary : "; cin >> salary;
node *temp = new node(ssn, name, dept, designation, salary); return temp;
}
...
int flag; cin >> flag; if (flag)
{
    node *temp = createNode(); last->next = temp;
...
{
node *ans = NULL; node *p = head; while (p)
{
if (p->name == name)
{
ans = p;
...
cout << "5. Exit ." << endl;
cout << "Enter the choice : "; int choice;
cin >> choice; switch (choice)
{
case 1:
e.create(); break;
case 2:
e.insert_Employee(); break;
case 3:
e.delete_Employee(); break;
case 4:
e.display(); break;
case 5:
exit(0); default:
